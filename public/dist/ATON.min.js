...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t={realize:function(){t.PATH_RES_ICONS=ATON.PATH_RES+"icons/",t._bPopup=!1,t.bPopupBlurBG=.25,t.urlParams=new URLSearchParams(window.location.search),t._uiSetupBase(),ATON.realize();var o=ATON.FE.urlParams.get("d");o&&o>0&&ATON.setDefaultPixelDensity(o)},addBasicLoaderEvents:function(){ATON.on("NodeRequestFired",function(){$("#idLoader").show()}),ATON.on("AllNodeRequestsCompleted",function(){$("#idLoader").hide(),void 0===ATON.Nav.homePOV?ATON.Nav.computeAndRequestDefaultHome(.5):ATON.Nav.requestHome(.5)})},loadSceneID:function(t){if(void 0!==t){var o=ATON.PATH_RESTAPI_SCENE+t;ATON.SceneHub._bEdit&&(o+=",edit"),ATON.SceneHub.load(o,t),console.log(o)}},uiBasicSetup:function(){t.uiAddButton("idTopToolbar","fullscreen",ATON.toggleFullScreen),ATON.Utils.isConnectionSecure()&&t.uiAddButton("idTopToolbar","vr",ATON.XR.toggle),t.uiAddButton("idBottomToolbar","home",function(){ATON.Nav.requestHome(.1)})},_uiSetupBase:function(){$("#idPopup").click(t.popupClose),$("#idLoader").html("<img src='"+ATON.PATH_RES+"loader.png'>")},uiAddButton:function(o,e,i){var n="<button id='btn-"+e+"' type='button' class='atonBTN'><img src='"+t.PATH_RES_ICONS+e+".png'></button>";$("#"+o).append(n),i&&$("#btn-"+e).click(i)},uiSwitchButton:function(t,o){o?$("#btn-"+t).addClass("switchedON"):$("#btn-"+t).removeClass("switchedON")},uiAddButtonHome:function(o){t.uiAddButton(o,"home",function(){ATON.Nav.requestHome(.3)})},uiAddButtonFirstPerson:function(o){t.uiAddButton(o,"fp",function(){ATON.Nav.isFirstPerson()?(ATON.Nav.setOrbitControl(),t.uiSwitchButton("fp",!1)):(ATON.Nav.setFirstPersonControl(),t.uiSwitchButton("fp",!0))})},uiAddButtonVR:function(o){ATON.Utils.isConnectionSecure()&&t.uiAddButton(o,"vr",ATON.XR.toggle)},uiAddButtonDeviceOrientation:function(o){ATON.Utils.isConnectionSecure()&&ATON.Utils.isMobile()&&t.uiAddButton(o,"devori",function(){ATON.Nav.isDevOri()?(ATON.Nav.setOrbitControl(),t.uiSwitchButton("devori",!1)):(ATON.Nav.setDeviceOrientationControl(),t.uiSwitchButton("devori",!0))})},uiAddButtonQR:function(o){t.uiAddButton(o,"qr",t.popupQR)},uiAddButtonFullScreen:function(o){t.uiAddButton(o,"fullscreen",function(){ATON.toggleFullScreen(),screenfull.isFullscreen?t.uiSwitchButton("fullscreen",!1):t.uiSwitchButton("fullscreen",!0)})},uiAddButtonVRC:function(o){t.uiAddButton(o,"vrc",function(){})},uiAttachInputFilterID:function(t){$("#"+t).on("keyup change input",function(){var o=$("#"+t).val(),e=new RegExp("[^A-Za-z-_]","ig");$("#"+t).val(o.replace(e,""))})},setupBasicUISounds:function(){t.auLib={},t.auLib.switch=new Audio(ATON.PATH_RES+"audio/switch.wav"),t.auLib.switch.loop=!1},popupShow:function(o){return!t._bPopup&&($("#idPopup").html("<div class='atonPopup' id='idPopupContent'>"+o+"</div>"),$("#idPopupContent").click(function(t){t.stopPropagation()}),$("#idPopup").fadeIn(),t._bPopup=!0,t.bPopupBlurBG>0&&(ATON._renderer.setPixelRatio(t.bPopupBlurBG),ATON._renderer.render(ATON._mainRoot,ATON.Nav._camera)),ATON._bPauseQuery=!0,!0)},popupClose:function(){t._bPopup=!1,t.bPopupBlurBG>0&&ATON.resetPixelDensity(),$("#idPopup").fadeOut(),ATON._bPauseQuery=!1,ATON.focusOn3DView()},popupQR:function(){if("<div class='atonQRcontainer' id='idQRcode'></div><br><br>",ATON.FE.popupShow("<h1>Share</h1><div class='atonQRcontainer' id='idQRcode'></div><br><br>")){var t=window.location.href;new QRCode(document.getElementById("idQRcode"),t)}}},o=t;exports.default=o;
