...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e={MODE_ADD:0,MODE_DEL:1,init:function(){e.currID=void 0,e.currData=void 0,e._bEdit=!1,e._bLoading=!1,e.initBaseParsers()},setEditMode:function(o){e._bEdit=o,console.log("Edit mode:"+o)},load:function(o,r,a){return e._bLoading=!0,console.log("Loading Scene: "+r),$.getJSON(o,function(o){e.currData=o,e.currID=r,e._bLoading=!1,e.parseScene(o),a&&a(),ATON.fireEvent("SceneJSONLoaded",r)})},parseScene:function(o){if(void 0!==(o=void 0===o?e.currData:o))for(var r in o)e._jsonParsers[r]&&e._jsonParsers[r](o[r])},getJSONchildren:function(e,o){void 0===o&&(o=ATON.NTYPES.SCENE);var r=void 0,a=[];if(o===ATON.NTYPES.SEM&&(r=ATON.getSemanticNode(e)),o===ATON.NTYPES.SCENE&&(r=ATON.getSceneNode(e)),void 0!==r){for(var n in r.children){var i=r.children[n];void 0!==i.nid&&a.push(i.nid)}return a}},getJSONgraphEdges:function(e){void 0===e&&(e=ATON.NTYPES.SCENE);var o=ATON.snodes;e===ATON.NTYPES.SEM&&(o=ATON.semnodes),e===ATON.NTYPES.UI&&(o=ATON.uinodes);var r={};for(var a in o){var n=o[a];n.parent&&n.parent.nid&&(void 0===r[n.parent.nid]&&(r[n.parent.nid]=[]),r[n.parent.nid].push(n.nid))}return r},getJSONsemanticSpheresList:function(e){var o=ATON.getSemanticNode(e);if(void 0!==o){var r=[];for(var a in o.children){var n=o.children[a];n.type&&r.push([parseFloat(n.position.x.toPrecision(3)),parseFloat(n.position.y.toPrecision(3)),parseFloat(n.position.z.toPrecision(3)),parseFloat(n.scale.x.toPrecision(3))])}return r}},getJSONsemanticConvexShapes:function(e){var o=ATON.getSemanticNode(e);if(void 0!==o){var r=[];for(var a in o.children){var n=o.children[a];n.userData._convexPoints&&r.push(n.userData._convexPoints)}return r}},initBaseParsers:function(){e._jsonParsers={},e._jsonParsers.environment=function(e){var o=e.mainpano;e.mainpano&&(o.url&&ATON.setMainPanorama(ATON.PATH_COLLECTION+o.url),o.rotation&&ATON.setMainPanoramaRotation(o.rotation));var r=e.mainlight;r&&(r.direction&&ATON.setMainLightDirection(new THREE.Vector3(r.direction[0],r.direction[1],r.direction[2])),ATON._dMainL&&(r.color&&(ATON._dMainL.color=new THREE.Color(r.color[0],r.color[1],r.color[2])),r.intensity&&(ATON._dMainL.intensity=r.intensity),r.shadows&&ATON.toggleShadows(r.shadows)))},e._jsonParsers.viewpoints=function(e){if(void 0!==e)for(var o in e){var r=e[o];"home"===o?ATON.Nav.setHomePOV((new ATON.POV).setPosition(r.position).setTarget(r.target).setFOV(r.fov).setKeywords(r.keywords)):new ATON.POV(o).setPosition(r.position).setTarget(r.target).setFOV(r.fov).setKeywords(r.keywords)}},e._jsonParsers.scenegraph=function(e){if(void 0!==e){var o=e.nodes,r=e.edges,a=function(e){var r=o[e],a=ATON.getOrCreateSceneNode(e).removeChildren(),n=r.urls;n&&(Array.isArray(n)?n.forEach(function(e){ATON.createSceneNode().load(ATON.PATH_COLLECTION+e).attachTo(a)}):a.load(ATON.PATH_COLLECTION+n)),r.shadowcast&&a.setShadowCast(r.shadowcast),r.shadowreceive&&a.setShadowCast(r.shadowreceive),r.toYup&&a.setYup();var i=r.transform;i&&(i.position&&a.setPosition(i.position[0],i.position[1],i.position[2]),i.rotation&&a.setRotation(i.rotation[0],i.rotation[1],i.rotation[2]),i.scale&&a.setScale(i.scale[0],i.scale[1],i.scale[2]))};for(var n in o)a(n);for(var i in r){var t=r[i],s=ATON.getSceneNode(i);if(void 0!==s)for(var d in t){var c=t[d],v=ATON.getSceneNode(c);void 0!==v&&v.attachTo(s)}}}},e._jsonParsers.semanticgraph=function(e){if(void 0!==e){var o=e.nodes,r=e.edges,a=function(e){var r=o[e],a=ATON.getOrCreateSemanticNode(e).removeChildren(),n=r.urls;n&&(Array.isArray(n)?n.forEach(function(e){ATON.createSemanticNode().load(ATON.PATH_COLLECTION+e).attachTo(a)}):a.load(ATON.PATH_COLLECTION+n)),r.toYup&&a.setYup();var i=r.spheres;if(Array.isArray(i))for(var t in i){var s=i[t];ATON.SemFactory.createSphere(e,new THREE.Vector3(s[0],s[1],s[2]),s[3])}var d=r.convexshapes;if(Array.isArray(d))for(var c in d){for(var v=d[c],N=[],T=0;T<v.length;T+=3){var O=new THREE.Vector3(v[T],v[T+1],v[T+2]);N.push(O)}ATON.SemFactory.createConvexShape(e,N)}};for(var n in o)a(n);for(var i in r){var t=r[i],s=ATON.getSemanticNode(i);if(void 0!==s)for(var d in t){var c=t[d],v=ATON.getSemanticNode(c);void 0!==v&&v.attachTo(s)}}}}},addSceneParser:function(o,r){e._jsonParsers[o]=r},sendEdit:function(o,r,a){if(!e._bLoading&&e._bEdit&&void 0!==o){void 0===r&&(r=e.MODE_ADD);var n=e.currID,i={};i.sid=n,i.data=o,i.mode=r===e.MODE_DEL?"DEL":"ADD";var t=JSON.stringify(i);$.ajax({url:ATON.PATH_RESTAPI+"edit/scene",type:"POST",data:t,contentType:"application/json; charset=utf-8",dataType:"json",success:function(o){void 0!==o&&(e.currData=o,a&&a())}})}}},o=e;exports.default=o;
