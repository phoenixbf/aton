...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=h(require("./ATON.node.js")),o=h(require("./ATON.pov.js")),n=h(require("./ATON.lightprobe.js")),i=h(require("./ATON.eventhub.js")),a=h(require("./ATON.mathub.js")),t=h(require("./ATON.utils.js")),r=h(require("./ATON.scenehub.js")),d=h(require("./ATON.audiohub.js")),s=h(require("./ATON.nav.js")),_=h(require("./ATON.xr.js")),u=h(require("./ATON.sui.js")),c=h(require("./ATON.vroadcast.js")),l=h(require("./ATON.semfactory.js")),v=h(require("./ATON.fe.js")),S=h(require("./ATON.mediarec.js")),f=h(require("./ATON.geoloc.js")),p=h(require("./ATON.apphub.js"));function h(e){return e&&e.__esModule?e:{default:e}}var m={};window.ATON=m,m.Node=e.default,m.POV=o.default,m.LightProbe=n.default,m.EventHub=i.default,m.Utils=t.default,m.SceneHub=r.default,m.MatHub=a.default,m.Nav=s.default,m.AudioHub=d.default,m.XR=_.default,m.SUI=u.default,m.VRoadcast=c.default,m.SemFactory=l.default,m.FE=v.default,m.MediaRec=S.default,m.GeoLoc=f.default,m.AppHub=p.default,m.STD_UPVECTOR=new THREE.Vector3(0,1,0),m.ROOT_NID=".",m.RAD2DEG=180/Math.PI,m.DEG2RAD=Math.PI/180,m.PATCH_ADD=0,m.PATCH_DEL=1,m.NTYPES={},m.NTYPES.SCENE=3,m.NTYPES.SEM=4,m.NTYPES.UI=5,m.PATH_RESTAPI=window.location.origin+"/api/",m.PATH_RESTAPI_SCENE=m.PATH_RESTAPI+"scene/",m.PATH_WAPPS=window.location.origin+"/a/",m.PATH_MODS=window.location.origin+"/mods/",m.PATH_THREE=m.PATH_MODS+"three/",m.PATH_DRACO_LIB=m.PATH_THREE+"examples/js/libs/draco/",m.PATH_BASIS_LIB=m.PATH_THREE+"examples/js/libs/basis/",m.PATH_COLLECTION=window.location.origin+"/collection/",m.PATH_SCENES=window.location.origin+"/scenes/",m.PATH_RES=window.location.origin+"/res/",m.PATH_FE=window.location.origin+"/fe/",m.SHADOWS_NEAR=.1,m.SHADOWS_FAR=50,m.SHADOWS_SIZE=15,m.SHADOWS_RES=1024,m.AMB_L=.1,m.setPathCollection=function(e){m.PATH_COLLECTION=e},m.setPathScenes=function(e){m.PATH_SCENES=e},m._onUserInteraction=function(){m._elPanoVideo&&!m._vpanoPlaying&&m._elPanoVideo.play(),"suspended"===m.AudioHub._listener.context.state&&m.AudioHub._listener.context.resume()},m._setupBaseListeners=function(){var e=m._renderer.domElement;window.addEventListener("resize",m._onResize,!1),window.onorientationchange=m._readDeviceOrientationMode,screenfull.isEnabled&&screenfull.on("change",function(){m._bFS=screenfull.isFullscreen,m.fireEvent("Fullscreen",m._bFS),m._bFS?console.log("Now fullscreen"):console.log("Exit fullscreen")}),e.addEventListener("mousemove",m._updateScreenMove,!1),e.addEventListener("mousedown",function(e){1===e.button&&m.fireEvent("MouseMidButton"),2===e.button&&m.fireEvent("MouseRightButton")}),e.addEventListener("wheel",m._onMouseWheel,!1),m._bPointerDown=!1,window.addEventListener("pointerdown",function(e){m._bPointerDown=!0,m._onUserInteraction()}),window.addEventListener("pointerup",function(e){m._bPointerDown=!1}),window.addEventListener("pointermove",function(e){m._bPointerDown&&(m._updateScreenMove(e),m._handleQueries())}),window.addEventListener("touchstart",function(e){m._bPointerDown=!0,m._onUserInteraction()}),window.addEventListener("touchend",function(e){m._bPointerDown=!1}),window.addEventListener("touchmove",function(e){m._bPointerDown&&(m._updateScreenMove(e.touches[0]),m._handleQueries())}),Hammer(e).on("doubletap",function(e){m._bPointerDown=!1,m.fireEvent("DoubleTap",e.srcEvent)}),Hammer(e).on("tap",function(e){if(m._bPointerDown=!1,m._onUserInteraction(),m._updateScreenMove(e.srcEvent),m._handleQueries(),m.fireEvent("Tap",e.srcEvent),void 0!==m._hoveredUI){var o=m.getUINode(m._hoveredUI);o&&o.onSelect&&o.onSelect()}}),m.on("DoubleTap",function(e){m.defaultDoubleTapFromScreenCoords(e)}),m._kModShift=!1,m._kModCtrl=!1,m._bListenKeyboardEvents=!0,window.addEventListener("keydown",function(e){m._onUserInteraction(),"Shift"===e.key&&(m._kModShift=!0),"Control"===e.key&&(m._kModCtrl=!0),m._bListenKeyboardEvents&&m.fireEvent("KeyPress",e.key)},!1),window.addEventListener("keyup",function(e){"Shift"===e.key&&(m._kModShift=!1),"Control"===e.key&&(m._kModCtrl=!1),m._bListenKeyboardEvents&&m.fireEvent("KeyUp",e.key)},!1),m.on("KeyPress",function(e){if("+"===e){var o=m.Nav.getFOV()+1;m.Nav.setFOV(o)}if("-"===e){var n=m.Nav.getFOV()-1;m.Nav.setFOV(n)}if("PageUp"===e){var i=m.SUI.mainSelector.scale.x+.02;m.SUI.setSelectorRadius(i)}if("PageDown"===e){var a=m.SUI.mainSelector.scale.x-.02;a=Math.max(a,.01),m.SUI.setSelectorRadius(a)}})},m._onResize=function(){m.Nav._camera.aspect=window.innerWidth/window.innerHeight,m.Nav._camera.updateProjectionMatrix(),m._renderer.setSize(window.innerWidth,window.innerHeight),console.log("onResize")},m._onMouseWheel=function(e){e.preventDefault(),m.fireEvent("MouseWheel",e.deltaY)},m.focusOn3DView=function(){m._renderer.domElement.focus()},m.defaultDoubleTapFromScreenCoords=function(e){if(m._updateScreenMove(e),m._handleQueryScene(),m.Nav._bControl)if(m.Nav.isFirstPerson()||m.Nav.isDevOri()){if(m.Nav.currentQueryValidForLocomotion()){var o=m._queryDataScene.p,n=(m._queryDataScene.n,m.Nav._vDir),i=new THREE.Vector3(o.x,o.y+m.userHeight,o.z),a=new THREE.Vector3(i.x+n.x,i.y+n.y,i.z+n.z),t=(new m.POV).setPosition(i).setTarget(a).setFOV(m.Nav._currPOV.fov);m.Nav.requestPOV(t,.5)}}else{var r=m.getSemanticNode(m._hoveredSemNode);m._queryDataSem&&r?m.Nav.requestPOVbyNode(r,.5):m._queryDataScene&&m.Nav.requestRetarget(m._queryDataScene.p,void 0,.5)}},m.isFullscreen=function(){return m._bFS},m.toggleFullScreen=function(){screenfull.toggle()},m.realize=function(){console.log("Initialize ATON..."),m.Utils.init(),m.Utils.profileDevice(),m._clock=new THREE.Clock(!0),m._bFS=!1;m._renderer=new THREE.WebGLRenderer({antialias:!0,alpha:!0,powerPreference:"high-performance"}),m._renderer.setSize(window.innerWidth,window.innerHeight),m._stdpxd=1,m._renderer.setPixelRatio(m._stdpxd),m._fps=60,m._dt=.01,m._avgFPScount=0,m._avgFPSaccum=0,m._avgFPS=60,m._aniMixers=[],m._renderer.outputEncoding=THREE.sRGBEncoding,m._renderer.toneMapping=THREE.LinearToneMapping,m._renderer.toneMappingExposure=1,m._renderer.setAnimationLoop(m._onFrame),m._maxAnisotropy=m._renderer.capabilities.getMaxAnisotropy(),console.log(m._renderer.capabilities),THREE.Cache.enabled=!0,m.userHeight=1.7,document.body.appendChild(m._renderer.domElement);var e=m._renderer.domElement;e.style.outline="none",e.style.border="none",m._vpanoPlaying=!1,m._bUserInts=0,m.EventHub.init(),m.MatHub.init(),m._assetsManager={},m._aLoader=new THREE.GLTFLoader,m._dracoLoader=new THREE.DRACOLoader,m._dracoLoader.setDecoderPath(m.PATH_DRACO_LIB),m._aLoader.setDRACOLoader(m._dracoLoader),m._numReqLoad=0,m._ccModels=[],m._updRoutines=[],m._lps=[],m._bAutoLP=!1,m._envMapInt=1,m._bShadowsFixedBound=!1,m._shadowsNear=m.SHADOWS_NEAR,m._shadowsFar=m.SHADOWS_FAR,m._shadowsSize=m.SHADOWS_SIZE,m._shadowsRes=m.SHADOWS_RES,m.initGraphs(),m.SceneHub.init(),m.AudioHub.init(),m.Nav.init(),m.XR.init(),m.SUI.init(),m.VRoadcast.init(),m.MediaRec.init(),m.SemFactory.init(),m.AppHub.init(),m.GeoLoc.init(),m._queryDataScene=void 0,m._queryDataSem=void 0,m._queryDataUI=void 0,m._hoveredSemNode=void 0,m._hoveredUI=void 0,m._bQuerySemOcclusion=!0,m._bQueryNormals=!0,m._bPauseQuery=!1,m._screenPointerCoords=new THREE.Vector2(0,0),m._rcScene=new THREE.Raycaster,m._rcScene.layers.set(m.NTYPES.SCENE),m._rcSemantics=new THREE.Raycaster,m._rcSemantics.layers.set(m.NTYPES.SEM),m._rcUI=new THREE.Raycaster,m._rcUI.layers.set(m.NTYPES.UI),m._setupBaseListeners(),m.device.isMobile&&m._readDeviceOrientationMode(),m._wappID=void 0,m.focusOn3DView()},m.renderPause=function(){m._renderer.setAnimationLoop(void 0)},m.renderResume=function(){m._renderer.setAnimationLoop(m._onFrame)},m._setupLoadManager=function(){m._loadManager=new THREE.LoadingManager,m._loadManager.onStart=function(e,o,n){console.log("Started loading file: "+e+".\nLoaded "+o+" of "+n+" files."),m.fireEvent("NodeRequestFired",e)},m._loadManager.onLoad=function(){console.log("Loading complete!"),m.fireEvent("AllNodeRequestsCompleted")},m._loadManager.onProgress=function(e,o,n){},m._loadManager.onError=function(e){console.log("There was an error loading "+e)}},m.setDefaultPixelDensity=function(e){m._stdpxd=e,m._renderer.setPixelRatio(e),void 0!==m._renderer.xr&&(m.device.isMobile?m._renderer.xr.setFramebufferScaleFactor(m._stdpxd*m.XR.MOBILE_DENSITY_F):m._renderer.xr.setFramebufferScaleFactor(m._stdpxd))},m.resetPixelDensity=function(){m._renderer.setPixelRatio(m._stdpxd)},m._readDeviceOrientationMode=function(){90===Math.abs(window.orientation)?(console.log("Landscape Mode"),m.fireEvent("MobileLandscapeMode")):(console.log("Portrait Mode"),m.fireEvent("MobilePortraitMode")),setTimeout(m._onResize,500)},m.snodes={},m.semnodes={},m.uinodes={},m.createSceneNode=function(e){return new m.Node(e,m.NTYPES.SCENE)},m.getSceneNode=function(e){if(void 0!==e)return m.snodes[e]},m.getOrCreateSceneNode=function(e){var o=m.getSceneNode(e);return void 0!==o?o:m.createSceneNode(e)},m.getRootScene=function(){return m._rootVisible},m.createSemanticNode=function(e){return new m.Node(e,m.NTYPES.SEM)},m.getSemanticNode=function(e){if(void 0!==e)return m.semnodes[e]},m.getOrCreateSemanticNode=function(e){var o=m.getSemanticNode(e);return void 0!==o?o:m.createSemanticNode(e)},m.getRootSemantics=function(){return m._rootSem},m.createUINode=function(e){return new m.Node(e,m.NTYPES.UI)},m.getUINode=function(e){if(void 0!==e)return m.uinodes[e]},m.getRootUI=function(){return m._rootUI},m._assetReqNew=function(e){m._numReqLoad++,m.fireEvent("NodeRequestFired",e)},m._assetReqComplete=function(e){m.fireEvent("NodeRequestCompleted",e),m._numReqLoad--,m._numReqLoad<=0&&m._onAllReqsCompleted()},m._onAllReqsCompleted=function(){var e=m._rootVisible.getBound().center,o=m._rootVisible.getBound().radius;m._renderer.shadowMap.enabled&&(m._rootVisible.traverse(function(e){e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),m.adjustShadowsParamsFromSceneBounds(),m._bShadowsFixedBound&&m.updateDirShadows(e)),m._bAutoLP&&(void 0===m._lps[0]?m.addLightProbe((new m.LightProbe).setPosition(e).setNear(o)):m._lps[0].setPosition(e.x,e.y,e.z).setNear(o),console.log("Auto LP")),e&&m._mMainPano&&m._mMainPano.position.copy(e),m.getRootScene().assignLightProbesByProximity(),m.fireEvent("AllNodeRequestsCompleted"),m._postAllReqsCompleted(),setTimeout(function(){m.updateLightProbes()},1e3)},m._postAllReqsCompleted=function(e){for(var o in void 0===e&&(e=m._rootVisible),e.children){var n=e.children[o];n&&n.toggle&&(m._postAllReqsCompleted(n),n.toggle(n.visible))}},m.initGraphs=function(){m._mainRoot=new THREE.Scene,m._mainRoot.background=new THREE.Color(.7,.7,.7),m._rootVisibleGlobal=new THREE.Group,m._mainRoot.add(m._rootVisibleGlobal),m._rootVisible=m.createSceneNode().setAsRoot(),m._rootVisibleGlobal.add(m._rootVisible),m._rootSem=m.createSemanticNode().setAsRoot(),m._mainRoot.add(m._rootSem),m._rootUI=m.createUINode().setAsRoot(),m._mainRoot.add(m._rootUI),m.ambLight=new THREE.AmbientLight(new THREE.Color(1,1,1)),m._rootVisibleGlobal.add(m.ambLight)},m.setBackgroundColor=function(e){m._mainRoot.background=e},m.setAutoLP=function(e){m._bAutoLP=e},m.setNeutralAmbientLight=function(e){m.ambLight.color=new THREE.Color(e,e,e)},m.addLightProbe=function(e){void 0!==e&&(0===m._lps.length&&m.setNeutralAmbientLight(m.AMB_L),m._lps.push(e),void 0!==m.SUI.gLPIcons&&u.default.addLPIcon(e))},m.updateLightProbes=function(){if(0!==m._lps.length){for(var e in m._lps)m._lps[e].update();m._lps[0]&&(m._indLP&&m._mainRoot.remove(m._indLP),m._indLP=THREE.LightProbeGenerator.fromCubeRenderTarget(m._renderer,m._lps[0]._prevCCtarget),m._indLP.intensity=1,m._mainRoot.add(m._indLP)),m._rootVisible.traverse(function(e){var o=e.userData.LP;void 0!==o&&o instanceof m.LightProbe&&(e.material.envMap=o.getEnvTex(),e.material.combine=THREE.AddOperation,e.material.envMapIntensity=m._envMapInt)}),console.log("LPs updated.")}},m.setMainPanorama=function(e){var o=void 0;e=m.Utils.resolveCollectionURL(e),m.Utils.isVideo(e)?(void 0===m._elPanoVideo&&(m._elPanoVideo=document.createElement("video"),m._elPanoVideo.id="idPanoVideo",m._elPanoVideo.innerHTML="<source src='"+e+"'>",m._elPanoVideo.crossOrigin="anonymous",m._elPanoVideo.loop=!0,m._elPanoVideo.playsinline=!0,m._elPanoVideo.style.cssText="display:none;",m._elPanoVideo.autoplay=!0,m._elPanoVideo.onplaying=function(){console.log("VideoPano playing"),m._vpanoPlaying=!0}),(o=new THREE.VideoTexture(m._elPanoVideo)).encoding=THREE.sRGBEncoding):(o=(new THREE.TextureLoader).load(e)).encoding=THREE.sRGBEncoding,void 0===m._matMainPano?(m._gMainPano=new THREE.SphereBufferGeometry(1,60,60),m._matMainPano=new THREE.MeshBasicMaterial({map:o,fog:!1,depthTest:!1,depthWrite:!1}),m._mMainPano=new THREE.Mesh(m._gMainPano,m._matMainPano),m._mMainPano.frustumCulled=!1,m.setMainPanoramaRadius(.9*m.Nav.STD_FAR),m._mMainPano.onAfterRender=function(){m._mMainPano.position.copy(m.Nav._currPOV.pos)},m._rootVisibleGlobal.add(m._mMainPano)):m._matMainPano.map=o},m.setMainPanoramaRadius=function(e){void 0!==m._gMainPano&&m._gMainPano.scale(-e,e,e)},m.setMainPanoramaRotation=function(e){void 0!==m._mMainPano&&m._mMainPano.rotation.set(0,e,0)},m.setMainLightDirection=function(e){var o=e.clone();o.normalize(),o.x*=.5*m.SHADOWS_FAR,o.y*=.5*m.SHADOWS_FAR,o.z*=.5*m.SHADOWS_FAR,void 0===m._dMainL&&(m._dMainL=new THREE.DirectionalLight(new THREE.Color(1,1,1),1),m._dMainL.castShadow=!1,m._dMainLtgt=new THREE.Object3D,m._rootVisibleGlobal.add(m._dMainLtgt),m._dMainL.target=m._dMainLtgt,m._rootVisibleGlobal.add(m._dMainL),m._dMainLpos=new THREE.Vector3),m._dMainLdir=o,m._dMainL.position.set(-o.x,-o.y,-o.z),m.toggleMainLight(!0)},m.getMainLightDirection=function(){if(void 0!==m._dMainLdir){var e=m._dMainLdir.clone();return e.normalize(),e}},m.toggleMainLight=function(e){void 0!==m._dMainL&&(m._dMainL.visible=e,e?(m.setNeutralAmbientLight(m.AMB_L),m.updateDirShadows()):m.setNeutralAmbientLight(1))},m.isMainLightEnabled=function(){return void 0!==m._dMainL&&!!m._dMainL.visible},m.setExposure=function(e){m._renderer.toneMappingExposure=e},m.getExposure=function(){return m._renderer.toneMappingExposure},m.adjustShadowsParamsFromSceneBounds=function(){var e=m._rootVisible.getBound().radius;m._rootVisible.getBound().center;e<=0||e>=m.SHADOWS_SIZE?(m._bShadowsFixedBound=!1,m._shadowsSize=m.SHADOWS_SIZE):(m._bShadowsFixedBound=!0,m._shadowsSize=1.5*e),m._dMainL.shadow.map&&(m._dMainL.shadow.map.dispose(),m._dMainL.shadow.map=null),m._dMainL.shadow.camera.left=-m._shadowsSize,m._dMainL.shadow.camera.right=m._shadowsSize,m._dMainL.shadow.camera.bottom=-m._shadowsSize,m._dMainL.shadow.camera.top=m._shadowsSize,m._dMainL.shadow.mapSize.width=m._shadowsRes,m._dMainL.shadow.mapSize.height=m._shadowsRes,m._dMainL.shadow.camera.near=m._shadowsNear,m._dMainL.shadow.camera.far=m._shadowsFar,m._dMainL.shadow.bias=-5e-4},m.toggleShadows=function(e){if(void 0!==m._dMainL)if(e){if(m._dMainL.castShadow=!0,m._renderer.shadowMap.enabled=!0,m.device.isMobile?m._renderer.shadowMap.type=THREE.PCFShadowMap:m._renderer.shadowMap.type=THREE.PCFSoftShadowMap,m._rootVisible.traverse(function(e){e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),m.adjustShadowsParamsFromSceneBounds(),m._bShadowsFixedBound){var o=m._rootVisible.getBound().center;m.updateDirShadows(o)}else m.updateDirShadows();console.log("Shadows ON")}else m._dMainL.castShadow=!1,m._renderer.shadowMap.enabled=!1,console.log("Shadows OFF")},m.updateDirShadows=function(e){void 0!==m._dMainLdir&&(void 0===e?(e=m.Nav.getCurrentEyeLocation(),m._dMainLpos.x=e.x+m.Nav._vDir.x*m._shadowsSize,m._dMainLpos.y=e.y+m.Nav._vDir.y*m._shadowsSize,m._dMainLpos.z=e.z+m.Nav._vDir.z*m._shadowsSize):(m._dMainLpos.x=e.x,m._dMainLpos.y=e.y,m._dMainLpos.z=e.z),m._dMainL.position.set(m._dMainLpos.x-m._dMainLdir.x,m._dMainLpos.y-m._dMainLdir.y,m._dMainLpos.z-m._dMainLdir.z),m._dMainLtgt.position.copy(m._dMainLpos))},m._updateEnvironment=function(){m._renderer.shadowMap.enabled&&(m._bShadowsFixedBound||m.updateDirShadows())},m.setGlobalAudio=function(e,o){void 0!==e&&(void 0===o&&(o=!0),e=m.Utils.resolveCollectionURL(e),void 0===m._auMain||null===m._auMain?m._auMain=new THREE.Audio(m.AudioHub._listener):m._auMain.isPlaying&&m._auMain.stop(),m.AudioHub._loader.load(e,function(e){m._auMain.setBuffer(e),m._auMain.setLoop(o),m._auMain.play()}))},m._onFrame=function(){var e=m._clock.getDelta();m._fps=1/e,m._dt=e,m._renderer.render(m._mainRoot,m.Nav._camera),m.XR._bPresenting?m.XR.update():m.Nav._controls.update(e),m._handleQueries(),m.Nav.update(),m.VRoadcast.update(),m.SUI.update(),m.MatHub.update(),m._updateEnvironment(),m._updateAniMixers(),m._updateRoutines()},m.addUpdateRoutine=function(e){void 0!==e&&m._updRoutines.push(e)},m.deleteAllUpdateRoutines=function(){m._updRoutines=[]},m._updateRoutines=function(){var e=m._updRoutines.length;if(!(e<=0))for(var o=0;o<e;o++)m._updRoutines[o]()},m._updateAniMixers=function(){for(var e=m._aniMixers.length,o=0;o<e;o++){m._aniMixers[o].update(m._dt)}},m._updateScreenMove=function(e){if(e.preventDefault&&e.preventDefault(),m.Nav._mode===m.Nav.MODE_DEVORI)return m._screenPointerCoords.x=0,void(m._screenPointerCoords.y=0);m._screenPointerCoords.x=e.clientX/window.innerWidth*2-1,m._screenPointerCoords.y=-e.clientY/window.innerHeight*2+1},m._registerRCS=function(){m._rcRR=0,m._rcHandlers=[],m._rcHandlers.push(m._handleQueryScene),m._rcHandlers.push(m._handleQuerySemantics),m._rcHandlers.push(m._handleQueryUI)},m._handleQueries=function(){m._bPauseQuery||m.Nav._bInteracting||m._numReqLoad>0||m.Nav.isTransitioning()||(m._handleQueryScene(),m._handleQuerySemantics(),m._handleQueryUI(),m.Nav.locomotionValidator())},m._handleQueryScene=function(){if(m.XR.isPresenting()?m.XR.setupQueryRay(m._rcScene):m._rcScene.setFromCamera(m._screenPointerCoords,m.Nav._camera),m._hitsScene=[],m._rcScene.intersectObjects(m._mainRoot.children,!0,m._hitsScene),m._hitsScene.length<=0)m._queryDataScene=void 0;else{var e=m._hitsScene[0];m._queryDataScene={},m._queryDataScene.p=e.point,m._queryDataScene.d=e.distance,m._queryDataScene.o=e.object,m._bQueryNormals&&null!==e.face&&void 0!==e.face.normal&&(m._queryDataScene.matrixWorld=(new THREE.Matrix3).getNormalMatrix(e.object.matrixWorld),m._queryDataScene.n=e.face.normal.clone().applyMatrix3(m._queryDataScene.matrixWorld).normalize())}},m.getSceneQueriedPoint=function(){if(void 0!==m._queryDataScene)return m._queryDataScene.p},m.getSceneQueriedDistance=function(){if(void 0!==m._queryDataScene)return m._queryDataScene.d},m.getSceneQueriedNormal=function(){if(void 0!==m._queryDataScene)return m._queryDataScene.n},m._handleQuerySemantics=function(){if(m.XR.isPresenting()?m.XR.setupQueryRay(m._rcSemantics):m._rcSemantics.setFromCamera(m._screenPointerCoords,m.Nav._camera),m._hitsSem=[],m._rcSemantics.intersectObjects(m._mainRoot.children,!0,m._hitsSem),m._hitsSem.length<=0){if(m._queryDataSem=void 0,m._hoveredSemNode){m.fireEvent("SemanticNodeLeave",m._hoveredSemNode);var e=m.getSemanticNode(m._hoveredSemNode);e&&e.onLeave&&e.onLeave()}m._hoveredSemNode=void 0}else{var o=m._hitsSem[0];if(m._bQuerySemOcclusion&&m._queryDataScene&&m._queryDataScene.d<o.distance){if(m._queryDataSem=void 0,m._hoveredSemNode){m.fireEvent("SemanticNodeLeave",m._hoveredSemNode);var n=m.getSemanticNode(m._hoveredSemNode);n&&n.onLeave&&n.onLeave()}m._hoveredSemNode=void 0}else{m._queryDataSem={},m._queryDataSem.p=o.point,m._queryDataSem.d=o.distance,m._queryDataSem.o=o.object,m._queryDataSem.list=[];for(var i=m._queryDataSem.list,a=o.object.parent;a;)a.nid&&a.nid!==m.ROOT_NID&&i.push(a.nid),a=a.parent;var t=i[0];if(t&&m._hoveredSemNode!==t){if(m._hoveredSemNode){m.fireEvent("SemanticNodeLeave",m._hoveredSemNode);var r=m.getSemanticNode(m._hoveredSemNode);r&&r.onLeave&&r.onLeave()}m._hoveredSemNode=t,m.fireEvent("SemanticNodeHover",t);var d=m.getSemanticNode(t);d&&d.onHover&&d.onHover()}}}},m._handleQueryUI=function(){if(m.XR.isPresenting()?m.XR.setupQueryRay(m._rcUI):m._rcUI.setFromCamera(m._screenPointerCoords,m.Nav._camera),m._hitsUI=[],m._rcUI.intersectObjects(m._mainRoot.children,!0,m._hitsUI),m._hitsUI.length<=0){if(m._queryDataUI=void 0,m._hoveredUI){m.fireEvent("UINodeLeave",m._hoveredUI);var e=m.getUINode(m._hoveredUI);e&&e.onLeave&&e.onLeave()}m._hoveredUI=void 0}else{var o=m._hitsUI[0];if(m._queryDataScene&&m._queryDataScene.d<o.distance){if(m._queryDataUI=void 0,m._hoveredUI){m.fireEvent("SemanticNodeLeave",m._hoveredUI);var n=m.getUINode(m._hoveredUI);n&&n.onLeave&&n.onLeave()}m._hoveredUI=void 0}else{m._queryDataUI={},m._queryDataUI.p=o.point,m._queryDataUI.d=o.distance,m._queryDataUI.o=o.object,m._queryDataUI.list=[];for(var i=m._queryDataUI.list,a=o.object.parent;a;)a.nid&&a.nid!==m.ROOT_NID&&i.push(a.nid),a=a.parent;var t=i[0];if(t&&m._hoveredUI!==t){if(m._hoveredUI){m.fireEvent("UINodeLeave",m._hoveredUI);var r=m.getUINode(m._hoveredUI);r&&r.onLeave&&r.onLeave()}m._hoveredUI=t,m.fireEvent("UINodeHover",t);var d=m.getUINode(t);d&&d.onHover&&d.onHover()}}}};var E=m;exports.default=E;
