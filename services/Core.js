...
Core.logGreen = (str)=>{
	console.log(colorize(str).green);
};
Core.logYellow = (str)=>{
	console.log(colorize(str).yellow);
};
...
Core.printLogo = ()=>{
	console.log(`       
           ...
           ]---    -OOOOOOOOOOOOOOOOOOOOOOOOOOt-    ---]           
           ]---   --OOOOOOOOOOOOOOOOOOOOOOOOOOJ-    ---[           
                  ]-OOOOOOOOOOOOO[OOOOOOOOOOOOX-                   
                   -zOOOOOOOOOOO--{OOOOOOOOOOO[-                   
                   --OOOOOOOOOO----1OOOOOOOOOQ-                    
                    -]OOOOOOOO]-----{OOOOOOOC--                    
                     --cOOOOO]-------}OOOOO(--                     
                       --rOO----------]OO)--                       
                       ---------------------                       
