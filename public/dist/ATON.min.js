...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;let e={TSTRING_SEPARATOR:" ",init:()=>{ATON.device={},e.geomUnitSphere=new THREE.SphereGeometry(1,16,16),e.exporterGLTF=void 0,e.exporterOBJ=void 0,e._dlink=document.createElement("a"),e._dlink.style.display="none",document.body.appendChild(e._dlink),e.textureLoader=new THREE.TextureLoader},generateID:e=>(void 0===e&&(e="id"),e+"-"+Math.random().toString(36).substr(2,9)),goToURL:e=>{window.location.href=e},isConnectionSecure:()=>window.isSecureContext,profileDevice:()=>{ATON.device.isMobile=!1;ATON.device.isMobile=(()=>!(!/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent)&&!/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(navigator.userAgent.substr(0,4))))(),ATON.device.xrSupported={},ATON.device.xrSupported["immersive-vr"]=!1,ATON.device.xrSupported["immersive-ar"]=!1,"xr"in navigator&&(navigator.xr.isSessionSupported("immersive-vr").then(e=>{ATON.device.xrSupported["immersive-vr"]=!!e,console.log("WebXR VR session support: "+ATON.device.xrSupported["immersive-vr"]),ATON.fireEvent("XR_support",{type:"immersive-vr",v:ATON.device.xrSupported["immersive-vr"]})}),navigator.xr.isSessionSupported("immersive-ar").then(e=>{ATON.device.xrSupported["immersive-ar"]=!!e,console.log("WebXR AR session support: "+ATON.device.xrSupported["immersive-ar"]),ATON.fireEvent("XR_support",{type:"immersive-ar",v:ATON.device.xrSupported["immersive-ar"]})}))},profileRenderingCapabilities:()=>{if(void 0===ATON._renderer)return;let e=ATON._renderer.capabilities;void 0!==e&&(ATON.device.lowGPU=!1,e.isWebGL2||(ATON.device.lowGPU=!0),e.maxTextureSize<8192&&(ATON.device.lowGPU=!0),console.log(e))},isMobile:()=>ATON.device.isMobile,isVRsupported:()=>ATON.device.xrSupported["immersive-vr"],isARsupported:()=>ATON.device.xrSupported["immersive-ar"],getFileExtension:e=>e.substr(e.lastIndexOf(".")+1).toLowerCase(),removeFileExtension:e=>e.replace(/\.[^/.]+$/,""),isVideo:t=>{let r=e.getFileExtension(t);return"mp4"===r||("webm"===r||void 0)},getBaseFolder:e=>{var t=e.lastIndexOf("/");return-1!==t?e.substring(0,t+1):""},isResourceURL:e=>!!e.startsWith("http://")||!!e.startsWith("https://"),URLify:e=>{const t=e.match(/(((ftp|https?):\/\/)[\-\w@:%_\+.~#?,&\/\/=]+)/g);return t&&t.forEach(function(t){e=e.replace(t,'<a target="_blank" href="'+t+'">'+t+"</a>")}),e},resolveCollectionURL:e=>e.startsWith("http")?e:ATON.PATH_COLLECTION+e,postJSON:(e,t,r,o)=>{$.ajax({url:e,type:"POST",xhrFields:{withCredentials:!0},data:JSON.stringify(t),contentType:"application/json; charset=utf-8",dataType:"json",success:e=>{r&&r(e)}}).fail(e=>{console.log(e),o&&o()})},mergeObject:e=>{e.updateMatrixWorld(!0);const t=[];e.traverse(e=>{if(e.isMesh){const r=e.geometry;r.applyMatrix4(e.matrixWorld),t.push(r.toNonIndexed())}});const r=THREE.BufferGeometryUtils.mergeBufferGeometries(t,!1),o=THREE.BufferGeometryUtils.mergeVertices(r).center(),a=new THREE.Group,i=new THREE.Mesh(o);return a.add(i),a},setPicking:(e,t,r)=>{void 0===r&&(r=!0),e.traverse(e=>{r?e.layers.enable(t):e.layers.disable(t)})},graphPostVisitor:t=>{t.visible?console.log(t):e.setPicking(t,t.type,!1)},updateTSetsCamera:e=>{void 0===e&&(e=ATON.Nav._camera);const t=ATON._tsets.length;if(!(t<=0))for(let r=0;r<t;r++){const t=ATON._tsets[r];for(let e in t.cameras)t.deleteCamera(t.cameras[e]);t.setCamera(e),t.setResolution(e,200,200)}},loadTileSet:(t,r)=>{let o=new TILES.TilesRenderer(t);if(!o)return;o.fetchOptions.mode="cors",o.setCamera(ATON.Nav._camera),o.setResolutionFromRenderer(ATON.Nav._camera,ATON._renderer);let a=!1;o.onLoadModel=(e=>{a||(ATON._onAllReqsCompleted(),a=!0),e.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0),e.material&&(r.userData.cMat&&(e.material=r.userData.cMat),e.material.map&&(e.material.map.minFilter=THREE.LinearMipmapLinearFilter,e.material.map.magFilter=THREE.LinearFilter))})}),o.onDisposeModel=(e=>{e.traverse(e=>{e.isMesh&&e.material.dispose()})}),r.add(o.group),e.setPicking(r,r.type,!0),ATON._tsets.push(o)},modelVisitor:(e,t)=>{if(!t)return;let r=e,o=r.type;t.traverse(e=>{e.isMesh&&(o===ATON.NTYPES.SCENE&&(e.castShadow=!0,e.receiveShadow=!0,e.geometry&&(e.geometry.computeBoundsTree(),console.log("Computed visible BVH")),null!==e.material.map&&(e.material.map.generateMipmaps=!0,e.material.map.anisotropy=ATON.device.isMobile?0:ATON._maxAnisotropy,e.material.map.minFilter=THREE.LinearMipmapLinearFilter,e.material.map.magFilter=THREE.LinearFilter)),o===ATON.NTYPES.SEM&&(e.material=ATON.MatHub.materials.semanticShape,e.geometry&&(e.geometry.computeBoundsTree(),console.log("Computed semantic BVH"))),r.userData.cMat&&(e.material=r.userData.cMat))})},registerAniMixers:(e,t)=>{let r=t.scene||t.scene[0],o=!1;if(void 0===t.animations)return;let a=new THREE.AnimationMixer(r);t.animations.forEach(e=>{a.clipAction(e).play(),o=!0}),o&&(ATON._aniMixers.push(a),void 0===e._aniMixers&&(e._aniMixers=[]),e._aniMixers.push(a))},ccExtract:e=>{if(void 0===e)return;if(void 0===e.asset)return;let t={};if(e.asset.copyright&&(t.copyright=e.asset.copyright),e.asset.extras)for(let r in e.asset.extras)t[r]=e.asset.extras[r];e.asset.generator&&(t.generator=e.asset.generator),(e.asset.copyright||e.asset.extras)&&ATON._ccModels.push(t),console.log(t)},parseTransformString:t=>{let r=new THREE.Group,o=t.split(e.TSTRING_SEPARATOR),a=o.length;return a<3?r:(r.position.set(parseFloat(o[0]),parseFloat(o[1]),parseFloat(o[2])),a<6?r:(r.rotation.set(parseFloat(o[3]),parseFloat(o[4]),parseFloat(o[5])),a<9?r:(r.scale.set(parseFloat(o[6]),parseFloat(o[7]),parseFloat(o[8])),r)))},setVectorPrecision:(e,t)=>(e.x=parseFloat(e.x.toPrecision(t)),e.y=parseFloat(e.y.toPrecision(t)),e.z=parseFloat(e.z.toPrecision(t)),e),checkAuth:e=>{$.ajax({type:"GET",url:ATON.PATH_RESTAPI+"user",xhrFields:{withCredentials:!0},dataType:"json",success:t=>{e(t)}})},getHumanReadableDistance:e=>{let t=" m";return e<.01?(t=" mm",t=(e*=1e3).toPrecision(3)+t):e<1?(t=" cm",t=(e*=100).toPrecision(3)+t):e>1e3?(t=" km",t=e.toPrecision(3)+t):t=e.toPrecision(3)+t},stripHTMLtagsFromString:e=>e=e.replace(/(<([^>]+)>)/gi,""),requestFullscreen:()=>{let e=document.documentElement;return e.requestFullscreen?e.requestFullscreen():e.mozRequestFullScreen?e.mozRequestFullScreen():e.webkitRequestFullscreen?e.webkitRequestFullscreen():e.msRequestFullscreen&&e.msRequestFullscreen(),!0},downloadBlob:(t,r)=>{void 0!==r&&(e._dlink.href=URL.createObjectURL(t),e._dlink.download=r,e._dlink.click())},downloadText:(t,r)=>{e.downloadBlob(new Blob([t],{type:"text/plain"}),r)},downloadJSONobj:(t,r)=>{e.downloadText(JSON.stringify(t),r)},downloadArrayBuffer:(t,r)=>{e.downloadBlob(new Blob([t],{type:"application/octet-stream"}),r)},exportNode:(t,r)=>{let o=e.getFileExtension(r);if(!(o.length<1)){if("glb"===o||"gltf"===o){let a={binary:"glb"===o};void 0===e.exporterGLTF&&(e.exporterGLTF=new THREE.GLTFExporter),e.exporterGLTF.parse(t,t=>{t instanceof ArrayBuffer?e.downloadArrayBuffer(t,r):(console.log(t),e.downloadJSONobj(t,r))},a)}if("obj"===o){void 0===e.exporterOBJ&&(e.exporterOBJ=new THREE.OBJExporter);let o=e.exporterOBJ.parse(t);e.downloadText(o,r)}}},takeScreenshot:(t,r)=>{let o=new Image;console.log("Screenshot with size:"+t),ATON.Nav._camera.aspect=1,ATON.Nav._camera.updateProjectionMatrix(),ATON._renderer.setSize(t,t),ATON._renderer.render(ATON._mainRoot,ATON.Nav._camera);let a=ATON._renderer.domElement;if(ATON.FX.composer){ATON.FX.composer.setSize(t,t);let e=ATON.FX.passes[ATON.FX.PASS_AA].material.uniforms;e&&e.resolution.value.set(1/t,1/t),ATON.FX.composer.render(),a=ATON.FX.composer.renderer.domElement}let i=ATON._renderer.domElement.toDataURL();return o.src=i,r&&(e._dlink.href=i.replace("image/png","image/octet-stream"),e._dlink.download=r,e._dlink.click()),ATON._onResize(),o},assignLightProbeToMesh:(e,t)=>{void 0!==e&&void 0!==t&&(t.noLP||(t.userData.LP=e))},createATONCube:t=>{let r=new THREE.BoxBufferGeometry(1,1,1),o=new THREE.MeshStandardMaterial;e.textureLoader.load(ATON.PATH_RES+"models/aton-cube.jpg",e=>{e.encoding=THREE.sRGBEncoding,o.map=e});let a=ATON.createSceneNode(t);return a.add(new THREE.Mesh(r)),a.setMaterial(o),a.enablePicking(),a},createATONCubePBR:t=>{let r=new THREE.BoxBufferGeometry(1,1,1),o=new THREE.MeshStandardMaterial;o.metalness=1,e.textureLoader.load(ATON.PATH_RES+"models/aton-cube.jpg",e=>{e.encoding=THREE.sRGBEncoding,o.map=e}),e.textureLoader.load(ATON.PATH_RES+"models/aton-cube-pbr.jpg",e=>{e.encoding=THREE.sRGBEncoding,o.metalnessMap=e,o.roughnessMap=e}),e.textureLoader.load(ATON.PATH_RES+"models/aton-cube-nrm.png",e=>{e.encoding=THREE.sRGBEncoding,o.normalMap=e});let a=ATON.createSceneNode(t);return a.add(new THREE.Mesh(r)),a.setMaterial(o),a.enablePicking(),a},createGround:(t,r,o)=>{void 0===r&&(r=1),void 0===o&&(o=1);let a=new THREE.PlaneBufferGeometry(r,o),i=new THREE.MeshStandardMaterial;void 0!==t&&e.textureLoader.load(t,e=>{e.encoding=THREE.sRGBEncoding,i.map=e});let s=ATON.createSceneNode().rotateX(.5*-Math.PI);return s.add(new THREE.Mesh(a,i)),s.enablePicking(),s}};var t=e;exports.default=t;
